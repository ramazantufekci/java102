...
public class OperatorGUI extends JFrame {
    ...
    private JTabbedPane tap_operator;
    ...
    private JTextField fld_course_lng;
    private JComboBox cmb_course_patika;
    private JComboBox cmd_course_user;
    ...
    public OperatorGUI(Operator operator){
        ...
        btn_course_add.addActionListener(e -> {
            ...
            Item userItem = (Item) cmd_course_user.getSelectedItem();
            if(Helper.isFieldEmpty(fld_course_name) || Helper.isFieldEmpty(fld_course_lng)){
                Helper.shwMsg("fill");
            }else{
                if(Course.add(userItem.getKey(), patikaItem.getKey(), fld_course_name.getText(),fld_course_lng.getText())){
                    Helper.shwMsg("done");
                    loadCourseModel();
                    fld_course_lng.setText(null);
    ...
    public void loadEducatorCombo(){
        cmd_course_user.removeAllItems();
        for(User obj: User.getListOnlyType("educator")){
            cmd_course_user.addItem(new Item(obj.getId(),obj.getName()));
        }
    }
